    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.card_facebook:
                ...
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/rijal.rochmansyah")));

                break;

            case R.id.card_instagram:

                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.instagram.com/rijalwris/s")));

                break;
            case R.id.card_git:

                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/RijalWris")));
